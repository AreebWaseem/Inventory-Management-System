...
public class forgot_password_new_password_fragment_view extends Fragment implements  LoginPostRequest.OnPostComplete{
    private static final String TAG = "forgot_password_new_pas";
    ...
    Context context;
    Button add_button;
    EditText new_password_add;
    String user_id_return="";
    @Nullable
    @Override
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {

        View view = inflater.inflate(R.layout.forgot_password_new_password_layout,container,false);
        circular_progress = (ProgressBar) view.findViewById(R.id.forgot_password_new_password_progress_bar);
        circular_progress.setVisibility(View.INVISIBLE);
        context=this.getActivity();
        add_button = (Button) view.findViewById(R.id.new_password_forgot_password_button);

        new_password_add= (EditText) view.findViewById(R.id.new_password_email_forgot_password_text_view);
        ...
        add_button.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if (new_password_add.getText().toString().equals("")  )
                {
                    Toast.makeText(getActivity(), getResources().getString(R.string.fields_cant_string), Toast.LENGTH_SHORT).show();
                }
                else {
                  user_id_return=  ((Forgot_password_Activity_final)getActivity()).user_id_returned;
                    myRequest = new LoginPostRequest(forgot_password_new_password_fragment_view.this, getActivity());
                    circular_progress.setVisibility(View.VISIBLE);
                    myRequest.execute("http://cloud.mdevsolutions.com/inventory/develop/api/auth/reset_password",user_id_return, new_password_add.getText().toString());
                }
    ...
    public void onResume() {
        ...
        ((Forgot_password_Activity_final)getActivity()).setActionBarStatus("new_password_fragment");
    ...
    public void onPostComplete(String s, PostStatus postStatus) {
        if (getActivity()!=null) {
            ...
            if (s != null) {
                ...
                ((Forgot_password_Activity_final)getActivity()).startfinish();
            }
        }
    }
